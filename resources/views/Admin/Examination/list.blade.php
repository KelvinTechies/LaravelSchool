        ...
        <section class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              ...
              <a href="{{url('admin/Examination/exam/add')}}" class='btn btn-primary'>Add New Exam</a>
                </ol>
              </div>
            </div>
          </div><!-- /.container-fluid -->
              ...
              <div class="row">
                          ...
                          <input type="text" class="form-control"value="{{Request::get('name')}}" name='name' placeholder="Exam Name">
                              ...
                              <div class="form-group col-md-3">
                                  ...
                                  <a href='{{url("admin/Examination/exam")}}' class='btn btn-success' type='submit' style="margin-top:30px;">Clear</a>
