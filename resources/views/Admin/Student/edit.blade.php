                                    ...
                                    <div class="card-body">
                                      ...
                                      <div class="form-group col-md-6">
                                          ...
                                          <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control"value="{{$getRecord->Admission_Number}}"  required name='Admission_Number' placeholder="Admission Number">
                                              </div>
                                              <div class="form-group col-md-6">
                                                    <label for="exampleInputEmail1">Roll Number<span style='color:red'>*</label></span>
                                                    <input type="text" class="form-control"value="{{$getRecord->Ref_num}}"  required name='Roll_Number' placeholder="Roll Number">
                                                  </div>
                                                  <div class="form-group col-md-6">
                                                                  ...
                                                                  <input type="text" value="{{$getRecord->Caste}}"  class="form-control"value='{{old('caste')}}' required name='caste' placeholder="Caste ">
                                                                      ...
                                                                      <input type="text"value="{{$getRecord->Religion}}"  class="form-control" required value='{{old('religion')}}' name='religion' placeholder="Roll Number">
                                                                          ...
                                                                          <input type="text" value="{{$getRecord->Phone}}" class="form-control"value='{{old('fone')}}' required name='fone' placeholder="Mobile Number">
                                                                              ...
                                                                              <input type="date"value="{{$getRecord->Admission_date}}"  class="form-control"value='{{old('admission_date')}}' required name='admission_date'>
                                                                                  </div>
