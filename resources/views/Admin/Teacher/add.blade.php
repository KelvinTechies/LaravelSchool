                                    ...
                                    <div class="card-body">
                                      ...
                                      <div class="form-group col-md-6">
                                          ...
                                          <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" required name='marital' placeholder="Occupation">
                                              </div>
                                                      <div class="form-group col-md-6">
                                                            <label for="exampleInputEmail1">Gender<span style='color:red'>*</label></span>
                                                                ...
                                                                <option {{ old('gender')=='Others'? 'selected': ""}} Value='Others'>Others</option>
                                                                      ...
                                                                      <div class="form-group col-md-6">
                                                                            ...
                                                                            <textarea name='address1' style="width:100%; height:100px;" placeholder="Current Address"></textarea>
                                                                          </div>
                                                                          <div class="form-group col-md-6">
                                                                                <label style="display:block;" for="exampleInputEmail1">Permanent Address <span style='color:red'>*</label></span>
                                                                        <textarea name='address2' style="width:100%; height:100px;" placeholder="Permanent Address"></textarea>
                                                                              </div>
                                                                          <div class="form-group col-md-6">
                                                                          ...
                                                                          <input type="text" class="form-control"value='{{old('fone')}}' required name='fone' placeholder="Mobile Number">
                                                                              ...
                                                                              <input type="date" class="form-control"value='{{old('dateJoined')}}' required name='dateJoined'>
                                                                                  </div>
                                                                                  <div class="form-group col-md-6">
                                                                                        <label for="exampleInputEmail1">Date Of Birth <span style='color:red'>*</label></span>
                                                                                  <input type="date" class="form-control"value='{{old('dob')}}' required name='dob' >
                                                                                      </div>
                                                                              <div class="form-group col-md-6">
                                                                                    <label style="display:block;" for="exampleInputEmail1">Qualification <span style='color:red'>*</label></span>
                                                                            <textarea name='Qualification' style="width:100%; height:100px;" placeholder="Qualification"></textarea>
                                                                                  </div>
                                                                                  <div class="form-group col-md-6">
                                                                                        <label style="display:block;" style="display:block;" for="exampleInputEmail1">Work Experience <span style='color:red'>*</label></span>
                                                                                <textarea name='experience' style="width:100%; height:100px;"  placeholder="Work Experience"></textarea>
                                                                                      </div>
                                                                                      <div class="form-group col-md-6">
                                                                                            <label style="display:block;" style="display:block;" for="exampleInputEmail1">Note  <span style='color:red'>*</label></span>
                                                                                    <textarea name='Note' style="width:100%; height:100px;"  placeholder="Note"></textarea>
                                                                                          </div>
